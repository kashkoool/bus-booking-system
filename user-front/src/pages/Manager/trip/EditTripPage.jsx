...
const EditTripPage = () => {
    ...
    const fetchData = async () => {
      try {
        ...
        const busesResponse = await axios.get(
          'http://localhost:5001/api/company/buses',
          {
            headers: {
              'Authorization': `Bearer ${token}`
            }
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.log('Manager companyID:', manager.companyID);
          ...
          <div className="mb-6 p-4 bg-green-50 border-l-4 border-green-500 rounded-lg">
            <div className="flex items-start">
              ...
              <div>
                ...
                <Link to="/manager/trip" className="text-blue-600 hover:underline mt-2 inline-block">الذهاب إلى قائمة الرحلات</Link>
              </div>
            </div>
          </div>
        )}
